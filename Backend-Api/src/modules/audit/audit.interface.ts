...
export enum AuditAction {
  ...
  // User Email Resend
  USER_EMAIL_RESEND_SUCCESS = "USER_EMAIL_RESEND_SUCCESS",
  USER_EMAIL_RESEND_FAILED = "USER_EMAIL_RESEND_FAILED",
  ...
  VAULT_TRANSFER_COMPLETED = "VAULT_TRANSFER_COMPLETED",
  VAULT_UNFROZEN = "VAULT_UNFROZEN",
  ...
  EMAIL_VERIFIED_FAILED = "EMAIL_VERIFIED_FAILED",
  TRANSFER_COMPLETED = "TRANSFER_COMPLETED",
  FORGET_PASSWORD_ATTEMPT = "FORGET_PASSWORD_ATTEMPT",
  USER_PASSWORD_RESET_CODE_VERIFIED = "PASSWORD_RESET_CODE_VERIFIED",
  ...
  RECONCILIATION_DRIFT_RESOLVED = "RECONCILIATION_DRIFT_RESOLVED",
