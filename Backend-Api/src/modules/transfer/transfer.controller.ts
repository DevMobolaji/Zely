...
class TransferController implements Controller {
  ...
  private initializeRoutes(): void {
    this.route.post(`${this.path}/p2p`, requireConsumerReady, requireAuth, this.p2pTransfer);
    this.route.post(`${this.path}/internal`, requireConsumerReady, requireAuth, this.internalTransfer);
    this.route.post(`${this.path}/to-vault`, requireConsumerReady, requireAuth, this.saveToVault);
  ...
  private getTransferFee = asyncWrapper(async (req: IAuthRequest, res: Response): Promise<Response> => {
