...
import { Home, List, Wallet, CreditCard, Settings, TrendingUp, LogOut, Activity, X, PiggyBank, ArrowLeftRight, Download, UserCircle } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, isSidebarOpen, setIsSidebarOpen, handleLogout }) => {
    ...
    const isActive = (path: string) => {
        ...
        if (path !== '/dashboard' && activeTab.startsWith(path)) return true;
        return false;
    };
            ...
            <div className="space-y-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Monthly Limit</p>
