            ...
            <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar">
                {['all', 'incoming', 'outgoing'].map((f) => (
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-bold capitalize whitespace-nowrap transition-all ${filter === f
                                    ...
                                    {(txs as Transaction[]).map((tx) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${tx.type === 'incoming'
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className={`text-[9px] sm:text-[10px] font-bold uppercase tracking-wider ${tx.status === 'success' ? 'text-green-500' : tx.status === 'pending' ? 'text-yellow-500' : 'text-red-500'
                                                    }`}>{tx.status}</p>
                                            </div>
                                        </div>
                                    ))}
