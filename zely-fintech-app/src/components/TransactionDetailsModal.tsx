        ...
        <div className="p-6 space-y-6">
          <div className="space-y-4">
            <div className="flex justify-between items-start">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-white text-right max-w-[200px]">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-white px-2 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg">
                ...
                <div className="flex items-start gap-3 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {transaction.merchantDetails.address}
                    </p>
                  </div>
                </div>
              </div>
